...
- 从llm prompt engineering （DeepSeek）-> Agentic （智能） Engineering (全栈)
...
## Agent 是什么？
其实就是给大模型扩展了Tool和Memory,它本来就可以思考、规划、你给它用tool扩展了能力。
它就可以**自动**做事情，用memory 管理记忆， 他就可以记住你想它记住的东西，还可以使用RAG查询内部知识来获取知识（context）。
